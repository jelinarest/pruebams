...
class CatalogoGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Catalogo entity")
        ...
        .repeat(2) {
            ...
            .get("/services/pruebams/api/catalogos")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new catalogo")
            .post("/services/pruebams/api/catalogos")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "nombre":"SAMPLE_TEXT"
            ...
            .repeat(5) {
                ...
                .get("/services/pruebams${new_catalogo_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created catalogo")
            .delete("/services/pruebams${new_catalogo_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
